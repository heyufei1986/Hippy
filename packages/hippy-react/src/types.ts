...
export interface TouchableProps {
   ...
   */
  onTouchDown?(evt: TouchEvent): boolean | undefined;
   ...
   * @param {number} evt.page_y = Touch coordinate Y
   */
  onTouchMove?(evt: TouchEvent): boolean | undefined;
   ...
   * @param {number} evt.page_y = Touch coordinate Y
   */
  onTouchEnd?(evt: TouchEvent): boolean | undefined;
   ...
   * @param {number} evt.page_y = Touch coordinate Y
   */
  onTouchCancel?(evt: TouchEvent): boolean | undefined;
}
