...
public abstract class RecyclerViewBase extends ViewGroup
{
  ...
  /* private */final com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.RecyclerViewDataObserver mObserver									= new com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.RecyclerViewDataObserver();

  protected com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Recycler mRecycler									= new com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Recycler();

  /* private */ com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SavedState mPendingSavedState;
  ...
  /* private */final ArrayList<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp>				mPendingUpdates								= new ArrayList<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp>();
  /* private */final ArrayList<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp>				mPendingLayoutUpdates						= new ArrayList<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp>();
  /* private */Pools.Pool<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp>					mUpdateOpPool								= new Pools.SimplePool<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp>(
    com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp.POOL_SIZE);

  public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Adapter<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder> mAdapter;
  public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutManager mLayout;
  /* private */final ArrayList<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ItemDecoration>		mItemDecorations							= new ArrayList<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ItemDecoration>();
  /* private */final ArrayList<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.OnItemTouchListener>	mOnItemTouchListeners						= new ArrayList<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.OnItemTouchListener>();
  /* private */ com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.OnItemTouchListener mActiveOnItemTouchListener;
  ...
  public final com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewFlinger mViewFlinger								= new com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewFlinger();
  private boolean										mShouldPrebindItem							= false;
  // protected final SpringBackHandler mSpringBackHandler = new
  // SpringBackHandler();

  public final com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.State mState										= new com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.State();

  /* private */ com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.OnScrollListener mScrollListener;
  ...
  protected com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.AutoScrollRunnable mAutoScrollRunnable;
  ...
  public RecyclerViewBase(Context context)
  {
    ...
    mAutoScrollRunnable = new com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.AutoScrollRunnable();
  ...
  public ArrayList<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder> getCachedViews()
  {
   ...
   */
  public void setAdapter(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Adapter adapter)
  {
    if (mAdapter != null)
    {
    ...
    final com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Adapter oldAdapter = mAdapter;
    mAdapter = adapter;
    if (adapter != null)
    {
   ...
   * @see #setAdapter(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Adapter)
   */
  public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Adapter getAdapter()
  {
    return mAdapter;
  }

  public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Recycler getRecycler()
  {
    return mRecycler;
  }
  ...
  /**
   * Set the {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutManager} that this RecyclerView will use.
   * <p/>
   * <p>
   ...
   * {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutManager}. A LayoutManager must be provided for RecyclerView
   * to function.
   * </p>
   * <p/>
   * <p>
   ...
   */
  public void setLayoutManager(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutManager layout)
  {
  ...
  {
    com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SavedState state = new com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SavedState(super.onSaveInstanceState());
  ...
  {
    mPendingSavedState = (com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SavedState) state;
  ...
  public View getAnimatingView(int position, int type)
  {
    if (mNumAnimatingViews > 0)
    {
      for (int i = mAnimatingViewIndex; i < getChildCount(); ++i)
      {
        ...
        com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder = getChildViewHolder(view);
  ...
  /**
   * Return the {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutManager} currently responsible for layout policy
   * for this RecyclerView.
   *
   * @return The currently bound LayoutManager
   */
  public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutManager getLayoutManager()
  {
    return mLayout;
  }

  /**
   * Retrieve this RecyclerView's {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.RecycledViewPool}. This method will
   * never return null; if no pool is set for this view a new one will be
   * created. See {@link #setRecycledViewPool(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.RecycledViewPool)
   * setRecycledViewPool} for more information.
   *
   * @return The pool used to store recycled item views for reuse.
   * @see #setRecycledViewPool(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.RecycledViewPool)
   */
  public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.RecycledViewPool getRecycledViewPool()
  {
   ...
   *            created and used.
   */
  public void setRecycledViewPool(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.RecycledViewPool pool)
  {
  ...
  /**
   * Add an {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ItemDecoration} to this RecyclerView. Item decorations can
   ...
   *            end.
   */
  public void addItemDecoration(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ItemDecoration decor, int index)
  {
   ...
   * @param decor Decoration to add
   */
  public void addItemDecoration(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ItemDecoration decor)
  {
    addItemDecoration(decor, -1);
  }

  /**
   * Remove an {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ItemDecoration} from this RecyclerView.
   * <p/>
   * <p>
   ...
   * @see #addItemDecoration(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ItemDecoration)
   */
  public void removeItemDecoration(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ItemDecoration decor)
  {
   ...
   */
  public void setOnScrollListener(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.OnScrollListener listener)
  {
  ...
  public void addOnItemTouchListener(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.OnItemTouchListener listener)
  {
    mOnItemTouchListeners.add(listener);
  }

  public void addOnItemTouchListenerToFront(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.OnItemTouchListener listener)
  {
    mOnItemTouchListeners.add(0, listener);
  }

  /**
   * Remove an {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.OnItemTouchListener}. It will no longer be able to
   * intercept touch events.
   *
   * @param listener Listener to remove
   */
  public void removeOnItemTouchListener(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.OnItemTouchListener listener)
  {
  ...
  /* private */boolean dispatchOnItemTouchIntercept(MotionEvent e)
  {
    ...
    {
      final com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.OnItemTouchListener listener = mOnItemTouchListeners.get(i);
  ...
  protected void dispatchLayout()
  {
    ...
    if (animateChangesSimple)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        final com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder = getChildViewHolderInt(getChildAtInItem(i));
        final View view = holder.itemView;
        mState.mPreLayoutHolderMap.put(holder,
          new com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ItemHolderInfo(holder, view.getLeft(), view.getTop(), view.getRight(), view.getBottom(), holder.mPosition));
      }
    }
    //		Log.d("leo", "preholder-------------");
    if (animateChangesAdvanced)
    {
      ...
      for (int i = 0; i < getChildCountInItem(); ++i)
      {
        ...
        {
          com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder = mState.mPreLayoutHolderMap.keyAt(j);
    ...
    if (animateChangesSimple)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder = getChildViewHolderInt(getChildAtInItem(i));
        final View view = holder.itemView;
      ...
      {
        com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder itemHolder = mState.mPreLayoutHolderMap.keyAt(i);
        if (!mState.mPostLayoutHolderMap.containsKey(itemHolder))
        {
          com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ItemHolderInfo disappearingItem = mState.mPreLayoutHolderMap.valueAt(i);
      ...
      if (postLayoutCount > 0)
      {
        ...
        {
          com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder itemHolder = mState.mPostLayoutHolderMap.keyAt(i);
          com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ItemHolderInfo info = mState.mPostLayoutHolderMap.valueAt(i);
      ...
      for (int i = 0; i < count; ++i)
      {
        com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder postHolder = mState.mPostLayoutHolderMap.keyAt(i);
        com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ItemHolderInfo postInfo = mState.mPostLayoutHolderMap.valueAt(i);
        com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ItemHolderInfo preInfo = mState.mPreLayoutHolderMap.get(postHolder);
  ...
  protected void handleLayoutHolder(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder postHolder, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ItemHolderInfo preInfo, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ItemHolderInfo postInfo)
  {
  ...
  protected void animateAppearance(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder itemHolder, Rect beforeBounds, int afterLeft, int afterTop)
  {
  ...
  protected void animateDisappearance(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ItemHolderInfo disappearingItem)
  {
    View disappearingItemView = disappearingItem.holder.itemView;
  ...
  void markItemDecorInsetsDirty()
  {
    ...
    for (int i = 0; i < childCount; i++)
    {
      ...
      ((com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams) child.getLayoutParams()).mInsetsDirty = true;
    }
  }
  ...
  {
    return p instanceof com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams && mLayout.checkLayoutParams((com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams) p);
  }
  ...
  /* private */int findPositionOffset(int position)
  {
    ...
    for (int i = 0; i < count; ++i)
    {
      com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp op = mPendingLayoutUpdates.get(i);
      if (op.positionStart <= position)
      {
        if (op.cmd == com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp.REMOVE)
        {
          offset -= op.itemCount;
        }
        else if (op.cmd == com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp.ADD)
        {
          offset += op.itemCount;
        }
      }
  ...
  void dispatchLayoutUpdates()
  {
    ...
    {
      final com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp op = mPendingLayoutUpdates.get(i);
      switch (op.cmd)
      {
        case com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp.ADD:
          mLayout.onItemsAdded(this, op.positionStart, op.itemCount);
          break;
        case com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp.REMOVE:
          mLayout.onItemsRemoved(this, op.positionStart, op.itemCount);
          break;
        case com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp.UPDATE:
          break;
      }
      recycleUpdateOp(op);
    }
  ...
  void updateChildViews()
  {
    ...
    for (int i = 0; i < opCount; i++)
    {
      final com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp op = mPendingUpdates.get(i);
      switch (op.cmd)
      {
        case com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp.ADD:
          if (DEBUG)
  ...
  {
    com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder = findViewHolderForPosition(position, true);
    if (holder != null)
    {
  ...
  void clearOldPositions()
  {
    ...
    for (int i = 0; i < childCount; i++)
    {
      final com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder = getChildViewHolderInt(getChildAt(i));
      if (holder != null)
      {
    ...
    for (int i = 0; i < childCount; i++)
    {
      ...
      if (holder != null)
      {
        ...
        else if (holder.mPosition >= positionStart)
        {
          ...
          holder.addFlags(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder.FLAG_REMOVED);
          mState.mStructureChanged = true;
        }
  ...
  {
    com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder vh = findViewHolderForPosition(pos, true);
    if (vh != null)
    {
  ...
  protected void handleViewRangeUpdate(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder, int positionStart, int positionEnd, int position, int itemCount)
  {
  ...
  protected void markKnownViewsInvalid()
  {
    ...
    for (int i = 0; i < childCount; i++)
    {
      ...
      if (holder != null)
      {
        holder.addFlags(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder.FLAG_UPDATE | com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder.FLAG_INVALID);
      }
    }
   ...
   * ListView does.
   */
  public void postAdapterUpdate(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp op)
  {
  ...
  /**
   * Retrieve the {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder} for the given child view.
   *
   * @param child Child of this RecyclerView to query for its ViewHolder
   * @return The child view's ViewHolder
   */
  public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder getChildViewHolder(View child)
  {
  ...
  protected static com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder getChildViewHolderInt(View child)
  {
    if (child == null)
    {
      return null;
    }
    return ((com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams) child.getLayoutParams()).mViewHolder;
  }
  ...
  {
    final com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder = getChildViewHolderInt(child);
   ...
   */
  public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder findViewHolderForPosition(int position)
  {
    return findViewHolderForPosition(position, false);
  }

  com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder findViewHolderForPosition(int position, boolean checkNewPosition)
  {
    final int childCount = getChildCount();
    for (int i = 0; i < childCount; i++)
    {
   ...
   * must use an Adapter with {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Adapter#setHasStableIds(boolean)
   ...
   *         is no such item.
   */
  public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder findViewHolderForItemId(long id)
  {
    final int childCount = getChildCount();
    for (int i = 0; i < childCount; i++)
    {
   ...
   * for implementing simple scrolling in {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutManager LayoutManagers}
   * .
   *
   ...
   * before a {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutManager} measures or lays out the view and is a
   ...
   * as a {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutManager} fully detaches the child view from the parent
   * and its window.
   * </p>
   *
  ...
  {
    final com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams lp = (com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams) child.getLayoutParams();
    if (!lp.mInsetsDirty)
    {
  ...
  public class ViewFlinger implements Runnable
  {
    ...
    public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.OnScrollFinishListener mScrollFinishListener;
    ...
    public void run()
    {
      ...
      final com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SmoothScroller smoothScroller = mLayout.mSmoothScroller;
      //Log.e("leo", "run");
    ...
    public void postOnAnimation()
    {
      ...
      {
        ViewCompatTool.postOnAnimation(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.this, this);
      }
    }
  ...
  /* private */class RecyclerViewDataObserver extends com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.AdapterDataObserver
  {
    @Override
    ...
    {
      postAdapterUpdate(obtainUpdateOp(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp.UPDATE, positionStart, itemCount));
    }
    ...
    {
      postAdapterUpdate(obtainUpdateOp(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp.ADD, positionStart, itemCount));
    }

    @Override
    public void onItemRangeRemoved(int positionStart, int itemCount)
    {
      postAdapterUpdate(obtainUpdateOp(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp.REMOVE, positionStart, itemCount));
    }

    @Override
    public void onItemsRemoved(ArrayList<Integer> removeItemPositions)
    {
      com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp op = obtainUpdateOp(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp.REMOVE, -1, -1);
      op.mRemovePositions = removeItemPositions;
      postAdapterUpdate(op);
    }
  }

  public static class ViewHolderArrayList extends ArrayList<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder>
  {
    @Override
  ...
  {
    public SparseArray<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolderArrayList>	mScrap				= new SparseArray<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolderArrayList>();
    ...
    public void setMaxRecycledViews(int viewType, int max, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Adapter adapter)
    {
      mMaxScrap.put(viewType, max);
      final ArrayList<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder> scrapHeap = mScrap.get(viewType);
      if (scrapHeap != null)
      {
        while (scrapHeap.size() > max)
        {
          com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder vh = scrapHeap.remove(scrapHeap.size() - 1);
          if (adapter != null)
          {
    ...
    public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder getRecycledView(int viewType, String itemReuseKey)
    {
      if (DEBUG)
      {
        Log.d(TAG, "getRecycledViewFromRecycler-->" + "type=" + viewType);
      ...
      if (scrapHeap != null && !scrapHeap.isEmpty())
      {
        ...
        com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder viewHolderReuse = scrapHeap.get(scrapHeap.size() - 1);
        if (!TextUtils.isEmpty(itemReuseKey))
        {
          for (int i = 0; i < scrapHeap.size(); i++)
          {
            com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder scrapHeapItem = scrapHeap.get(i);
    ...
    public void putRecycledView(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder scrap, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Adapter adapter)
    {
    ...
    void attach(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Adapter adapter)
    {
      mAttachCount++;
    }
    ...
    void onAdapterChanged(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Adapter oldAdapter, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Adapter newAdapter)
    {
      if (mAttachCount == 1)
      {
        clear();
    ...
    /* private */
    public ArrayList<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder> getScrapHeapForType(int viewType)
    {
      com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolderArrayList scrap = mScrap.get(viewType);
      if (scrap == null)
      {
        scrap = new com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolderArrayList();
   ...
   * <p/>
   * <p>
   * Typical use of a Recycler by a {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutManager} will be to obtain
  ...
  {
    /* private */public final ArrayList<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder>	mAttachedScrap				= new ArrayList<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder>();

    /* private */public final ArrayList<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder>	mCachedViews				= new ArrayList<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder>();

    /* private */final List<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder>				mUnmodifiableAttachedScrap	= Collections.unmodifiableList(mAttachedScrap);

    /* private */int								mViewCacheMax				= DEFAULT_CACHE_SIZE;

    /* private */public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.RecycledViewPool mRecyclerPool;
    ...
    public String dump()
    {
      if (DEBUG)
      {
        ...
        for (com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder vh : mCachedViews)
        {
          sb.append(vh + "\n");
        }
     ...
     */
    public List<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder> getScrapList()
    {
     ...
     *         otherwise
     */
    boolean validateViewHolderForOffsetPosition(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder, int offsetPosition)
    {
    ...
    public View getSuspendViewForPosition(int position)
    {
      ...
      com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder = null;
      ...
      if (holder == null)
      {
        ...
        {
          holder = mAdapter.createSuspendViewHolderWithPos(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.this, offsetPosition, mAdapter.getItemViewType(offsetPosition));
        }
      }
      if (holder != null)
      {
        ...
        ((com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams) lp).mViewHolder = holder;
        if (DEBUG)
        {
     ...
     * <p/>
     * <p>
     * This method should be used by {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutManager} implementations
     * to obtain views to represent data from an {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Adapter}.
     * </p>
     * <p/>
     * <p>
    ...
    public View getViewForPosition(int position)
    {
      ...
      com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder;
      final int offsetPosition = findPositionOffset(position);
      ...
      if (getLayoutManager() instanceof BaseLayoutManager && !isRepeatableSuspensionMode())
      {
        ...
        if (currentSuspentionView != null && offsetPosition == ((BaseLayoutManager) getLayoutManager()).getCurrentSuspentionPosition())
        {
          ...
          {
            com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder suspentionViewHolder = getChildViewHolder(currentSuspentionView);
      ...
      if (holder == null)
      {
        ...
        else
        {
          ...
          holder = mAdapter.createViewHolderWithPos(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.this, offsetPosition, mAdapter.getItemViewType(offsetPosition));
          if (holder == null)
          {
            holder = mAdapter.createViewHolder(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.this, mAdapter.getItemViewType(offsetPosition));
          }
          if (holder == null)
          {
    ...
    protected void handleBindViewHolderInGetView(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder, int offsetPosition)
    {
      if (holder.mBindNextTime || holder.mForceBind || !holder.isRemoved() && (!holder.isBound() || holder.needsUpdate()))
      {
        holder.mBindNextTime = false;
    ...
    public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder getViewHolderForPosition(int offsetPosition)
    {
      com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder = getScrapViewForPosition(offsetPosition, INVALID_TYPE);
    ...
    void recycleCachedViews()
    {
      ...
      for (int i = count - 1; i >= 0; i--)
      {
        final com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder cachedView = mCachedViews.get(i);
    ...
    void recycleViewHolder(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder)
    {
      ...
      if (holder.mViewType != com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder.TYPE_NORMAL)
      {
        return;
      }
    ...
    {
      final com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder = getChildViewHolderInt(view);
     ...
     * </p>
     */
    void unscrapView(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder)
    {
    ...
    public View getScrapFooterView(int position)
    {
      ...
      {
        com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder = mAttachedScrap.get(i);
     ...
     */
    com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder getScrapViewForPosition(int position, int type)
    {
      if (DEBUG)
      {
      ...
      for (int i = 0; i < scrapCount; i++)
      {
        final com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder = mAttachedScrap.get(i);
      ...
      {
        final com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder = mCachedViews.get(i);
    ...
    com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder getScrapViewForId(long id, int type)
    {
    ...
    public void dispatchViewRecycled(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder)
    {
    ...
    void setRecycledViewPool(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.RecycledViewPool pool)
    {
    ...
    public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.RecycledViewPool getRecycledViewPool()
    {
      if (mRecyclerPool == null)
      {
        mRecyclerPool = new com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.RecycledViewPool();
      }
      return mRecyclerPool;
    }

    com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder findViewHolderForPosition(int position)
    {
      final int cachedCount = mCachedViews.size();
      for (int i = 0; i < cachedCount; i++)
      {
    ...
    com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder findViewHolderForItemId(long id)
    {
      if (!mAdapter.hasStableIds())
      {
        return null;
    ...
    void viewRangeUpdate(int positionStart, int itemCount)
    {
      ...
      for (int i = 0; i < cachedCount; i++)
      {
        ...
        {
          holder.addFlags(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder.FLAG_UPDATE);
        }
      }
    }
    ...
    public void updateHolderPositionWhenDelete(int index)
    {
      ...
      if (index >= 0)
      {
        ...
        final ArrayList<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder> scrapHeap = getRecycledViewPool().mScrap.get(viewType);
        if (scrapHeap != null && !scrapHeap.isEmpty())
        {
          // traverse all scrap
          for (com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder : scrapHeap)
          {
  ...
  public static abstract class Adapter<VH extends com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder>
  {
    ...
    /* private */final com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.AdapterDataObservable mObservable				= new com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.AdapterDataObservable();
    /* private */boolean						mHasStableIds			= false;
    protected boolean							mSuspentionDataChanged	= false;


    public abstract VH onCreateViewHolder(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase parent, int viewType);

    public VH onCreateViewHolderWithPos(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase parent, int position, int viewType)
    {
      return null;
    }

    public VH onCreateSuspendViewHolderWithPos(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase parent, int position, int viewType)
    {
      return null;
    }
    ...
    public final VH createViewHolder(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase parent, int viewType)
    {
    ...
    public final VH createViewHolderWithPos(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase parent, int position, int viewType)
    {
    ...
    public final VH createSuspendViewHolderWithPos(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase parent, int position, int viewType)
    {
    ...
    public final void bindViewHolder(VH holder, int position, boolean doBind, int layoutType, int cardType)
    {
      ...
      holder.setFlags(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder.FLAG_BOUND, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder.FLAG_BOUND | com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder.FLAG_UPDATE | com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder.FLAG_INVALID);
    }
     ...
     * fall back to a generic {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.AdapterDataObserver#onChanged()
     ...
     * {@link #unregisterAdapterDataObserver(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.AdapterDataObserver)
     * unregistering} those observers when finished.
     * </p>
     *
     * @param observer Observer to register
     * @see #unregisterAdapterDataObserver(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.AdapterDataObserver)
     */
    public void registerAdapterDataObserver(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.AdapterDataObserver observer)
    {
     ...
     * @see #registerAdapterDataObserver(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.AdapterDataObserver)
     */
    public void unregisterAdapterDataObserver(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.AdapterDataObserver observer)
    {
    ...
    public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder findBestHolderForPosition(int offsetPosition, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Recycler recycler)
    {
      return null;
    }

    public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder findSuspendHolderForPosition(int offsetPosition, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Recycler recycler)
    {
      return null;
    }
  ...
  {
    public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase mRecyclerView;
    public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SmoothScroller mSmoothScroller;
     ...
     * accordingly.
     */
    public int				mPendingScrollPosition			= com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.NO_POSITION;
     ...
     */
    public void onAttachedToWindow(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase view)
    {
    }
     ...
     * @param view The RecyclerView this LayoutManager is bound to
     */
    public void onDetachedFromWindow(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase view)
    {
    }

    public void onLayoutChildren(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Recycler recycler, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.State state)
    {
      //			Log.e(TAG, "You must override onLayoutChildren(Recycler recycler, State state) ");
    }

    public abstract com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams generateDefaultLayoutParams();
     ...
     */
    public boolean checkLayoutParams(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams lp)
    {
      return lp != null;
    }
     ...
     * {@link #checkLayoutParams(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams)},
     ...
     */
    public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams generateLayoutParams(ViewGroup.LayoutParams lp)
    {
      if (lp instanceof com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams)
      {
        return new com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams((com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams) lp);
      }
      else if (lp instanceof MarginLayoutParams)
      {
        return new com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams((MarginLayoutParams) lp);
      }
      else
      {
        return new com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams(lp);
      }
    }
     ...
     * @return a new LayoutParams object
     */
    public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams generateLayoutParams(Context c, AttributeSet attrs)
    {
      return new com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams(c, attrs);
    }
     ...
     */
    public int scrollHorizontallyBy(int dx, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Recycler recycler, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.State state)
    {
      return 0;
    }
     ...
     *         if a boundary was reached.
     */
    public int scrollVerticallyBy(int dy, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Recycler recycler, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.State state)
    {
      return 0;
    }
     ...
     * {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SmoothScroller} instance and call
     * {@link #startSmoothScroll(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SmoothScroller)}.
     * </p>
     *
     ...
     * @param position Scroll to this adapter position.
     */
    public void smoothScrollToPosition(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase recyclerView, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.State state, int position)
    {
      // Log.e(TAG,
     ...
     *            animated
     */
    public void startSmoothScroll(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SmoothScroller smoothScroller)
    {
     ...
     * {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Recycler} using {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Recycler#getViewForPosition(int)}.
     *
    ...
    public void addView(View child, int index)
    {
      ...
      else
      {
        ...
        final com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Adapter adapter = mRecyclerView.getAdapter();
        if (adapter != null)
        {
     ...
     * {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Recycler#recycleView(View)}.
     *
    ...
    public void removeViewAt(int index)
    {
      ...
      if (child != null)
      {
        ...
        if (lp != null && lp instanceof com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams)
        {
          com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams rvLp = (com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams) lp;
          if (rvLp.mViewHolder != null)
          {
            com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder vh = rvLp.mViewHolder;
            if (vh.mViewType == com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder.TYPE_FOOTER)
            {
              mRecyclerView.mState.mFooterCountInScreen--;
            }
            if (vh.mViewType == com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder.TYPE_HEADERE)
            {
    ...
    public int getPosition(View view)
    {
      ...
      return ((com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams) view.getLayoutParams()).getViewPosition();
    }
    ...
    public void attachView(View child, int index, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams lp)
    {
    ...
    {
      attachView(child, index, (com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams) child.getLayoutParams());
    }
    ...
    /**
     * Detach a child view and add it to a {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Recycler Recycler's} scrap
     * heap.
     * <p/>
     * <p>
     ...
     */
    public void detachAndScrapView(View child, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Recycler recycler)
    {
      detachView(child);
     ...
     * @param recycler Recycler to deposit the new scrap view into
     */
    public void detachAndScrapViewAt(int index, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Recycler recycler)
    {
     ...
     */
    public void removeAndRecycleView(View child, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Recycler recycler)
    {
      removeView(child);
     ...
     * @param recycler Recycler to use to recycle child
     */
    public void removeAndRecycleViewAt(int index, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Recycler recycler)
    {
    ...
    {
      final com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Adapter a = mRecyclerView != null ? mRecyclerView.getAdapter() : null;
     ...
     */
    public void detachAndScrapAttachedViews(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Recycler recycler)
    {
     ...
     */
    protected void removeAndRecycleScrapInt(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Recycler recycler, boolean remove, boolean recycle)
    {
    ...
    {
      com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams lp = null;
      if (child == null)
      {
        return;
      }
      ...
      {
        lp = (com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams) child.getLayoutParams();
      }
      else
      {
        lp = generateDefaultLayoutParams();
    ...
    public static int getChildMeasureSpec(int parentSize, int padding, int childDimension, boolean canScroll)
    {
      ...
      else
      {
        ...
        else if (childDimension == com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams.FILL_PARENT)
        {
          resultSize = size;
          resultMode = MeasureSpec.EXACTLY;
        }
        else if (childDimension == com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams.WRAP_CONTENT)
        {
          resultSize = size;
     ...
     * size of any insets applied by {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ItemDecoration ItemDecorations}.
     *
     * @param child Child view to query
    ...
    {
      final Rect insets = ((com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams) child.getLayoutParams()).mDecorInsets;
     ...
     * coordinates that include any current {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ItemDecoration
     * ItemDecorations}.
     * <p/>
     * <p>
     ...
     * offset by any applied {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ItemDecoration ItemDecorations}.
     *
     ...
     */
    public View onFocusSearchFailed(View focused, int direction, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Recycler recycler, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.State state)
    {
      return null;
    }
     ...
     */
    public boolean requestChildRectangleOnScreen(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase parent, View child, Rect rect, boolean immediate)
    {
      try
      {
     ...
     */
    public boolean onRequestChildFocus(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase parent, View child, View focused)
    {
      return false;
    }

    public void onAdapterChanged(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Adapter oldAdapter, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Adapter newAdapter)
    {
    }
     ...
     */
    public boolean onAddFocusables(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase recyclerView, ArrayList<View> views, int direction, int focusableMode)
    {
      return false;
    }
     ...
     * @param itemCount
     */
    public void onItemsAdded(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase recyclerView, int positionStart, int itemCount)
    {
    }
     ...
     * @param itemCount
     */
    public void onItemsRemoved(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase recyclerView, int positionStart, int itemCount)
    {
    }

    public int computeHorizontalScrollExtent(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.State state)
    {
      return 0;
    }

    public int computeHorizontalScrollOffset(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.State state)
    {
      return 0;
    }

    public int computeHorizontalScrollRange(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.State state)
    {
      return 0;
    }

    public int computeVerticalScrollExtent(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.State state)
    {
      return 0;
    }

    public int computeVerticalScrollOffset(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.State state)
    {
      return 0;
    }

    public int computeVerticalScrollRange(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.State state)
    {
      return 0;
    }
     ...
     */
    public void onMeasure(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Recycler recycler, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.State state, int widthSpec, int heightSpec)
    {
    ...
    /* private */void onSmoothScrollerStopped(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SmoothScroller smoothScroller)
    {
    ...
    void removeAndRecycleAllViews(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Recycler recycler)
    {
    ...
    public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams onCreateItemLayoutParams(RecyclerView.ViewHolderWrapper holder, int position, int layoutType,
                                                                                                               int cardType)
    {
      return new com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams.WRAP_CONTENT, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams.WRAP_CONTENT);
    }
  }
  ...
  public static abstract class ItemDecoration
  {
     ...
     */
    public void onDraw(Canvas c, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase parent)
    {
    }
     ...
     * @param parent RecyclerView this ItemDecoration is drawing into
     */
    public void onDrawOver(Canvas c, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase parent)
    {
    }
     ...
     */
    public void getItemOffsets(Rect outRect, int itemPosition, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase parent)
    {
      outRect.set(0, 0, 0, 0);
    }
  }
  ...
  public interface OnItemTouchListener
  {
     ...
     */
    boolean onInterceptTouchEvent(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase rv, MotionEvent e);
     ...
     *            are in the RecyclerView's coordinate system.
     */
    void onTouchEvent(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase rv, MotionEvent e);
  }
   ...
   * <p/>
   * <p>
   * {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Adapter} implementations should subclass ViewHolder and add fields
   * for caching potentially expensive {@link View#findViewById(int)} results.
   * </p>
   * <p/>
   * <p>
   * While {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams} belong to the {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutManager},
   * {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder ViewHolders} belong to the adapter. Adapters should
  ...
  public static abstract class ViewHolder
  {
    ...
    // other data by the
    // scrap container.
    /* private */ com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Recycler mScrapContainer		= null;

    public boolean				mPosDirty;

    protected com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase mParent;
    ...
    public ViewHolder(View itemView, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase rv)
    {
      this.mParent = rv;
      if (itemView == null)
      {
    ...
    public void setScrapContainer(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Recycler recycler)
    {
  ...
  public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp obtainUpdateOp(int cmd, int positionStart, int itemCount)
  {
    com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp op = mUpdateOpPool.acquire();
    if (op == null)
    {
      op = new com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp(cmd, positionStart, itemCount);
    }
    else
    {
      op.cmd = cmd;
  ...
  void recycleUpdateOp(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.UpdateOp op)
  {
  ...
  {
    public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder mViewHolder;
    ...
    public LayoutParams(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutParams source)
    {
  ...
  /**
   * Observer base class for watching changes to an {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Adapter}. See
   * {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.Adapter#registerAdapterDataObserver(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.AdapterDataObserver)}.
   */
  ...
  public static abstract class SmoothScroller
  {
    ...
    /* private */int				mTargetPosition	= com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.NO_POSITION;

    /* private */ com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase mRecyclerView;

    /* private */ com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutManager mLayoutManager;
    ...
    /* private */final com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SmoothScroller.Action mRecyclingAction;

    public SmoothScroller()
    {
      mRecyclingAction = new com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SmoothScroller.Action(0, 0);
    }

    void start(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase recyclerView, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutManager layoutManager)
    {
      mRecyclerView = recyclerView;
      mLayoutManager = layoutManager;
      if (mTargetPosition == com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.NO_POSITION)
      {
    ...
    final protected void stop()
    {
      ...
      onStop();
      mRecyclerView.mState.mTargetPosition = com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.NO_POSITION;
      mTargetView = null;
      mTargetPosition = com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.NO_POSITION;
    ...
    {
      if (!mRunning || mTargetPosition == com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.NO_POSITION)
      {
        stop();
      }
      mPendingInitialRun = false;
     ...
     * updateStyle the provided {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SmoothScroller.Action} to define the next scroll.
     * </p>
     *
     ...
     */
    abstract protected void onSeekTargetStep(int dx, int dy, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.State state, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SmoothScroller.Action action);
     ...
     * provided {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SmoothScroller.Action} to define the scroll details towards the
     * target view.
     *
     ...
     * @return An {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SmoothScroller.Action} to finalize the smooth scrolling
     */
    abstract protected void onTargetFound(View targetView, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.State state, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SmoothScroller.Action action);

    /**
     * Holds information about a smooth scroll request by a
     * {@link com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SmoothScroller}.
     */
    public static class Action
    {
      ...
      /* private */void runInNecessary(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase recyclerView)
      {
        if (changed)
        {
          validate();
  ...
  static class AdapterDataObservable extends Observable<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.AdapterDataObserver>
  {
  ...
  static class SavedState extends BaseSavedState
  {
    ...
    {
      super(in);
      mLayoutState = in.readParcelable(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.LayoutManager.class.getClassLoader());
    }
    ...
    /* private */void copyFrom(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SavedState other)
    {
      mLayoutState = other.mLayoutState;
    }

    public static final Creator<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SavedState> CREATOR = new Creator<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SavedState>()
    {
      @Override
      public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SavedState createFromParcel(Parcel in)
      {
        return new com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SavedState(in);
      }

      @Override
      public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SavedState[] newArray(int size)
      {
        return new com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SavedState[size];
      }
    };
  }
  ...
  public static class State
  {
    ...
    /* private */int									mTargetPosition									= com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.NO_POSITION;
    /* private */ArrayMap<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ItemHolderInfo>	mPreLayoutHolderMap								= new ArrayMap<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ItemHolderInfo>();
    /* private */ArrayMap<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ItemHolderInfo>	mPostLayoutHolderMap							= new ArrayMap<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ItemHolderInfo>();
    ...
    com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.State reset()
    {
      mTargetPosition = com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.NO_POSITION;
      if (mData != null)
      {
    ...
    {
      return mTargetPosition != com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.NO_POSITION;
    }
  ...
  {
    public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder;
    public int			left, top;

    ItemHolderInfo(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder, int left, int top, int right, int bottom, int position)
    {
      this.holder = holder;
      this.left = left;
      this.top = top;
  ...
  public void scrollToTop(com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.OnScrollFinishListener listener)
  {
    if (mLayout.canScrollHorizontally()) {
  ...
  protected boolean canTranversal(int purpose, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder)
  {
    return true;
  }
  ...
  public void traversal(int tracersalPurpose)
  {
    ...
    if (tracersalPurpose != TRAVERSAL_PURPOSE_MODECHANGE)
    {
      if (count > 0)
      {
        ...
        {
          View child = getChildAt(i);
          com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder = getChildViewHolderInt(child);
          if (holder != null)
          {
    ...
    {
      final com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder = mRecycler.mAttachedScrap.get(i);
      if (holder != null)
      {
        if (canTranversal(tracersalPurpose, holder))
        {
    ...
    for (int i = 0; i < cacheSize; i++)
    {
      final com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder = mRecycler.mCachedViews.get(i);
      if (holder != null)
      {
        if (canTranversal(tracersalPurpose, holder))
        {
    ...
    {
      final com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder = mRecycler.mUnmodifiableAttachedScrap.get(i);
      if (holder != null)
      {
        if (canTranversal(tracersalPurpose, holder))
        {
    ...
    {
      ArrayList<com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder> scrapHeap = getRecycledViewPool().mScrap.valueAt(i);
      if (scrapHeap != null)
      {
        final int scrapHeapSize = scrapHeap.size();
        for (int j = 0; j < scrapHeapSize; j++)
        {
          com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder holder = scrapHeap.get(j);
          if (holder != null)
          {
            holder.inTraversals(tracersalPurpose);
          }
  ...
  public com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.ViewHolder createViewHolder(View itemView, com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase rv)
  {
    return null;
  }
